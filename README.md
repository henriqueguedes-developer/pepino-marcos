...
⚙️ Funcionalidades
 CRUD Completo: Criação, Leitura e Exclusão de eventos.
 Paginação: Navegação otimizada entre listas de eventos.
 Busca em Tempo Real: Filtragem por título ou categoria.
 Detalhes Dinâmicos: Rotas individuais (/events/[id]) com dados atualizados.
...
Estados de loading em botões.
 Design Responsivo: Layout fluido para Mobile e Desktop.
📸 Galeria do Projeto
...
Clone o repositório: ```bash git clone https://github.com/marcos-lima-dev/desafio-tecnico-analista-de-sistemas-Junior-front-end.git
cd desafio-tecnico-analista-de-sistemas-Junior-front-end Instale as dependências:
...
📝 Notas do Desenvolvedor Persistência de Dados: Como este é um desafio técnico com foco em Front-end, não foi utilizado banco de dados externo. A persistência é feita em memória (src/data/events.ts).
